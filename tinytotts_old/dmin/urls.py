...
urlpatterns = patterns('',
	...
	url(r'^dmin/user/userupdate/(\d+)/$', views.userupdate, name='edit'),
        url(r'^dmin/user/userdelete/(\d+)/$', views.userdelete, name='delete'),
	url(r'^dmin/register/$', views.register, name='register'),
	#url(r'^dmin/groups/$', views.groups, name='groups'),
