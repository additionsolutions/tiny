...
urlpatterns = patterns('',
 ...
 url(r'^dmin/testsetline/delete/(?P<pk>\d+)$', views.testsetline_delete, name='testsetline_delete'),
    ...
    url(r'^dmin/summaryreporttest/$',views.testwise_summaryreport, name='testwise_summaryreport'),
    url(r'^dmin/testsummary/(\d{1,2})$',views.get_testsummaryreport, name='get_testsummaryreport'),
    url(r'^dmin/testsetuser_flag/$', views.testsetuser_flag, name='user_flag'),
    url(r'^dmin/phoneticslist/$', views.phonetics_list, name='phonetics_list'),
    url(r'^dmin/phonetics/new$', views.phonetics_create, name='phonetics_new'),
    url(r'^dmin/phonetics/edit/(?P<pk>\d+)$', views.phonetics_update, name='phonetics_edit'),
    url(r'^dmin/phonetics/delete/(?P<pk>\d+)$', views.phonetics_delete, name='phonetics_delete'),
    url(r'^dmin/phoneticsline/$', views.phonetics_line, name='phonetics_line'),
	url(r'^dmin/phonetics_line/new$', views.phoneticsline_create, name='phoneticsline_new'),
    url(r'^dmin/phoneticsline/edit/(?P<pk>\d+)$', views.phoneticsline_update, name='phoneticsline_edit'),
    url(r'^dmin/phoneticsline/delete/(?P<pk>\d+)$', views.phoneticsline_delete, name='phoneticsline_delete'),
        )
